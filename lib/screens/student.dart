...
class _StudentState extends State<Student> {
  ...
  Future<List<ClassicStudent>> _handleStudent() async {
    ...
    var res = await http.get(url, headers: {
      ...
      "Cookie": "$sessionID; $csrfToken; $serverid",
...
class _DetailState extends State<Detail> {
  ...
  void patchStudent() async {
    ...
    try {
      ...
      var data = {"img": dd};
      var url = "http://valzyzt.cluster024.hosting.ovh.net/api/v1/student/$id/";
        ...
        body: SingleChildScrollView(
          ...
          Container(
              ...
              fontSize: 15,
                  ...
                  Text(student.nom_du_pediatre + " :   " + student.tlf_pediatre,
                      style: TextStyle(
                        color: Colors.white,
                        fontFamily: "LuckiestGuy",
                        fontSize: 20,
              ...
              fontSize: 15,
                  ...
                  Text(
                      student.other_responsible_name +
                          " : " +
                          student.other_responsible_tlf,
                      style: TextStyle(
                        color: Colors.white,
                        fontFamily: "LuckiestGuy",
                        fontSize: 20,
