...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future showNotification() async {
    var url = "http://valzyzt.cluster024.hosting.ovh.net/api/v1/notification/";
  ...
  Future<List<ClassicHomepage>> _handleHompage() async {
    ...
    if (group != null) {
      ...
      var url = "http://valzyzt.cluster024.hosting.ovh.net/api/v1/homepage/";
      var res = await http.get(url, headers: {
        'Content-Type': 'application/json',
        "Accept": "application/json",
        "Cookie": "$sessionId; $csrfToken; $server",
                            ...
                            Center(
                              child: Column(
                                children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      children: <Widget>[
                                        ...
                                        Container(
                                            child: Center(
                                          child: snapshot.data[index].theme ==
                                                  null
                                              ? Text(
                                                  "Pas de Théme",
                                                  style: TextStyle(
                                  ...
                                  Align(
                                      alignment: Alignment.centerLeft,
                                      child: snapshot.data[index].message ==
                                              null
                                          ? Text("")
                                        ...
                                        child: Hero(
                                          ...
                                          child: Center(
                                            child: snapshot.data[index]
                                                    ...
                                                    null
                                                ? Text(
                                                    'Pas De Planning Pour La Cantine')
...
class Detail extends StatefulWidget {
  ...
  Detail(this.home, {index});

  @override
  _DetailState createState() => _DetailState(home, index);
}

class _DetailState extends State<Detail> {
  final ClassicHomepage home;
  
  _DetailState(this.home);
  Widget build(BuildContext context) {
        ...
        child: Center(
          child: Hero(
              ...
              child: images[index] == null
                  ? Text('')
                  : PhotoView(imageProvider: NetworkImage(images[index]))),
        ),
        onTap: () {},
      ),
    );
      ...
      body: GestureDetector(
        child: Center(
          child: Hero(
            ...
            PhotoView(imageProvider: NetworkImage(home.Event_img))
      ...
      body: GestureDetector(
        child: Center(
          child: Hero(
            ...
            Text("Pas d'image du jour"):
            PhotoView(imageProvider: NetworkImage(home.daily_img))
      ...
      body: GestureDetector(
        child: Center(
          child: Hero(
            ...
            PhotoView(imageProvider: NetworkImage(home.planning_cantine))
        ...
        child: Center(
          child: Hero(
            ...
            Text('Pas de planning Du Goûter'):
             PhotoView(imageProvider: NetworkImage(home.planning_goute))
      ...
      body: GestureDetector(
        child: Center(
          child: Hero(
            ...
            Text('Pas De Citations'):
            PhotoView(imageProvider: NetworkImage(home.citation))
